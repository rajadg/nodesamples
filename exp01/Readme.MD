...
- [Express JS Development](#express-js-development)
  ...
  - [6. Middleware](#6-middleware)
    - [Examples](#examples)
      - [6.1 Basic Middleware](#61-basic-middleware)
      - [6.2 Multiple Middlewares](#62-multiple-middlewares)
      - [6.3 Middleware for a route](#63-middleware-for-a-route)
      - [6.4 Adding middleware for all urls](#64-adding-middleware-for-all-urls)
...
More details: https://expressjs.com/en/guide/using-middleware.html

### Examples
#### 6.1 Basic Middleware
...
#### 6.4 Adding middleware for all urls
